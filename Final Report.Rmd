...
Room_type, accomodates, bedrooms, and some random intercept and slope between overall_satisfaction and neighborhood will be the main effect of the price. 
...
For the price model, in the binnedplot, there are still a lot of points outside of the fitted line. One of the reason might be that the dataset has many outliers. Maybe I can clean the data in a beter way next time.
